...
function mapToDetail(r: RestaurantResponse): RestaurantDetail {
  ...
  return {
    ...
    weeklyVoteDelta: 0,
    voteTrend: [
      { label: '5/4', value: Math.max(0, voteCount - 70) },
      { label: '5/5', value: Math.max(0, voteCount - 52) },
      { label: '5/6', value: Math.max(0, voteCount - 38) },
      { label: '5/7', value: Math.max(0, voteCount - 29) },
      { label: '5/8', value: Math.max(0, voteCount - 18) },
      { label: '5/9', value: Math.max(0, voteCount - 7) },
      { label: '5/10', value: voteCount },
    ],
    images: [
